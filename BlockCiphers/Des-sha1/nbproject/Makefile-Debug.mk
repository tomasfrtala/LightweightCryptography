...
${OBJECTDIR}/src/des/des.o: src/des/des.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/des/des.o src/des/des.cpp
