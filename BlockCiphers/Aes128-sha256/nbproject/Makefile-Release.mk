...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/aes128-sha256

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/aes128-sha256: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/aes128-sha256 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/aes/aes128_dec.o: src/aes/aes128_dec.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes128_dec.o src/aes/aes128_dec.cpp

${OBJECTDIR}/src/aes/aes128_enc.o: src/aes/aes128_enc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/aes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes128_enc.o src/aes/aes128_enc.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/aes128-sha256
