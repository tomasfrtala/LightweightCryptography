...
${OBJECTDIR}/src/present/present80.o: src/present/present80.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/present/present80.o src/present/present80.cpp
