...
${OBJECTDIR}/src/aes/aes256_dec.o: src/aes/aes256_dec.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes256_dec.o src/aes/aes256_dec.cpp

${OBJECTDIR}/src/aes/aes256_enc.o: src/aes/aes256_enc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/aes
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes256_enc.o src/aes/aes256_enc.cpp
