...
${OBJECTDIR}/src/aes/aes192_dec.o: src/aes/aes192_dec.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes192_dec.o src/aes/aes192_dec.cpp

${OBJECTDIR}/src/aes/aes192_enc.o: src/aes/aes192_enc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/aes
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/libraries/EEPROM -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/aes/aes192_enc.o src/aes/aes192_enc.cpp
