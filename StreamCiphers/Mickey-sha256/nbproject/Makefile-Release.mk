...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/mickey/mickey128.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mickey-sha256

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mickey-sha256: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mickey-sha256 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/mickey/mickey128.o: src/mickey/mickey128.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/mickey
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mickey/mickey128.o src/mickey/mickey128.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mickey-sha256
